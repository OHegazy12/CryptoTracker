    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Text(crypto.priceChangePercentage24H.PercentConverter())
                .font(.title2)
                .foregroundColor(crypto.priceChangePercentage24H < 0 ? .red : .green)
        }
...
//struct ColdestCurrency_Previews: PreviewProvider {
